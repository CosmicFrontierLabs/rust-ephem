...
It is designed to handle the common case where a mission simulator exports an
ephemeris file and you want to feed it into the ``rust-ephem``
constraint-evaluation pipeline without re-propagating from scratch.
...
A representative offset-based simulator file looks like:

.. code-block:: text

    # Mission simulator ephemeris export
    # Generated by MySimulator v2.0
...
+----------------+------------------------------------------------------------+
| ``"auto"``     | Try numeric offset first, then ISO 8601 / natural-language. |
| (default)      |                                                            |
+----------------+------------------------------------------------------------+
...
* Natural-language: ``15 Oct 2028 00:00:00.000000``
