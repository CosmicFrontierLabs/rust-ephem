...
@pytest.fixture
def sample_oem_path(tmp_path: Path) -> Generator[str, None, None]:
...
class TestCCSDSEphemeris:
    def test_ccsds_ephemeris_initialization(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_gcrs_data(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_interpolation(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_itrs_conversion(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_sun_moon(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_index_method(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_time_range_validation(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_oem_pv_property(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_angular_radius(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_oem_timestamp(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_invalid_reference_frame(self, tmp_path: Path) -> None:
...
"""
    ...
    def test_ccsds_ephemeris_missing_reference_frame(self, tmp_path: Path) -> None:
...
"""
    ...
    def test_ccsds_ephemeris_sun_moon_pv(self, sample_oem_path: str) -> None:
    ...
    def test_ccsds_ephemeris_obsgeoloc_obsgeovel(self, sample_oem_path: str) -> None:
