"""Fixtures for integration_test_sun_moon_skycoord tests."""
...
@pytest.fixture
def sun(ephem: Any) -> Any:
    """Create Sun SkyCoord from ephemeris."""
    return ephem.sun


@pytest.fixture
def moon(ephem: Any) -> Any:
    """Create Moon SkyCoord from ephemeris."""
    return ephem.moon
