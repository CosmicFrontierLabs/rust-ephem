...
class TestSunAngularRadius:
    ...
    def test_sun_radius_quantity_returns_astropy_quantity(
    ...
    def test_sun_radius_deg_returns_numpy_array(self, tle_ephemeris: Any) -> None:
    ...
    def test_sun_radius_rad_returns_numpy_array(self, tle_ephemeris: Any) -> None:
    ...
    def test_sun_radius_deg_and_rad_conversion(self, tle_ephemeris: Any) -> None:
    ...
    def test_sun_radius_quantity_matches_deg(self, tle_ephemeris: Any) -> None:
    ...
    def test_sun_radius_in_expected_range(self, tle_ephemeris: Any) -> None:
    ...
    def test_sun_radius_available_on_ground_ephemeris(
    ...
    def test_sun_radius_available_on_spice_ephemeris(
...
class TestMoonAngularRadius:
    ...
    def test_moon_radius_quantity_returns_astropy_quantity(
        self, tle_ephemeris: Any
    ) -> None:
    ...
    def test_moon_radius_deg_returns_numpy_array(self, tle_ephemeris: Any) -> None:
    ...
    def test_moon_radius_rad_returns_numpy_array(self, tle_ephemeris: Any) -> None:
    ...
    def test_moon_radius_deg_and_rad_conversion(self, tle_ephemeris: Any) -> None:
        """Degrees and radians should be consistent"""
    ...
    def test_moon_radius_quantity_matches_deg(self, tle_ephemeris: Any) -> None:
        """Quantity value should match degrees array"""
        quantity = tle_ephemeris.moon_radius
        deg = tle_ephemeris.moon_radius_deg
        assert np.allclose(quantity.value, deg, rtol=1e-10)

    def test_moon_radius_in_expected_range(self, tle_ephemeris: Any) -> None:
    ...
    def test_moon_radius_available_on_ground_ephemeris(
        self, ground_ephemeris: Any
    ) -> None:
    ...
    def test_moon_radius_available_on_spice_ephemeris(
        self, spice_ephemeris: Any
    ) -> None:
...
class TestEarthAngularRadius:
    ...
    def test_earth_radius_quantity_returns_astropy_quantity(
        self, tle_ephemeris: Any
    ) -> None:
    ...
    def test_earth_radius_deg_returns_numpy_array(self, tle_ephemeris: Any) -> None:
    ...
    def test_earth_radius_rad_returns_numpy_array(self, tle_ephemeris: Any) -> None:
    ...
    def test_earth_radius_deg_and_rad_conversion(self, tle_ephemeris: Any) -> None:
        """Degrees and radians should be consistent"""
    ...
    def test_earth_radius_quantity_matches_deg(self, tle_ephemeris: Any) -> None:
        """Quantity value should match degrees array"""
        quantity = tle_ephemeris.earth_radius
        deg = tle_ephemeris.earth_radius_deg
        assert np.allclose(quantity.value, deg, rtol=1e-10)

    def test_earth_radius_in_expected_range_for_leo(self, tle_ephemeris: Any) -> None:
    ...
    def test_earth_radius_near_90_for_ground_observer(
        self, ground_ephemeris: Any
    ) -> None:
    ...
    def test_earth_radius_small_from_moon(self, spice_ephemeris: Any) -> None:
    ...
    def test_earth_radius_quantity_near_90_for_ground_observer(
        self, ground_ephemeris: Any
    ) -> None:
...
class TestAngularRadiusCaching:
    ...
    def test_sun_radius_deg_is_cached(self, tle_ephemeris: Any) -> None:
    ...
    def test_moon_radius_rad_is_cached(self, tle_ephemeris: Any) -> None:
        """Multiple accesses should return the same object (cached)"""
        first = tle_ephemeris.moon_radius_rad
        second = tle_ephemeris.moon_radius_rad
        assert first is second

    def test_earth_radius_deg_is_cached(self, tle_ephemeris: Any) -> None:
        """Multiple accesses should return the same object (cached)"""
        first = tle_ephemeris.earth_radius_deg
        second = tle_ephemeris.earth_radius_deg
        assert first is second

    def test_caching_improves_performance(self, tle_ephemeris: Any) -> None:
...
class TestAngularRadiusConsistency:
    ...
    def test_sun_radius_similar_for_tle_and_ground(
        self, tle_ephemeris: Any, ground_ephemeris: Any
    ) -> None:
    ...
    def test_all_properties_return_same_length_arrays(self, tle_ephemeris: Any) -> None:
...
class TestAngularRadiusEdgeCases:
    ...
    def test_properties_available_for_single_timestamp(self) -> None:
    ...
    def test_properties_available_for_many_timestamps(self) -> None:
    ...
    def test_radians_are_smaller_than_degrees(self, tle_ephemeris: Any) -> None:
