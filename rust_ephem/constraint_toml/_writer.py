...
See the :mod:`rust_ephem.constraint_toml` package docstring for the full
rationale; in short, combinators flatten to ``[definitions.*]`` tables plus
an ``expression`` string instead of nested TOML tables.
"""
